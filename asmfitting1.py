...
def ASMfitting(frame, grayimg):
    ...
    return final_features, coords

image = cv2.imread('ironman.jpg')
#print(image)
gi = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
#cv2.imwrite('images/gray_image.png',gi)

ans=ASMfitting(image,gi)
print(ans)
print(ans[0]['CJWR'])
